...
const CarListOptions = ({ distance,  handleBookNow }) => {
  ...
  return ( 
    <div>
        ...
        { selectedCar?
          <div className='relative flex justify-between bottom-4 items-center font-bold text-center w-full text-slate-700 p-4 shadow-xl bg-white  md:w-full sm:w-full border-[1px] rounded-sm '>
